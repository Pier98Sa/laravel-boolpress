...
<h1 style="margin: 0; color: #555555; font-size: 33px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">BOOLPRESS</span></h1>
</td>
</tr>
</table>
</td>
...
<p style="margin: 0; font-size: 16px; text-align: center;"><span style="font-size:30px;color:#2b303a;"><strong>Nuovo messaggio</strong></span></p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 30px;"><span style="font-size:20px;"><strong>Ciao Admin !</strong></span></p>
<p style="margin: 0; font-size: 12px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size:16px;"><strong>Hai ricevuto un nuovo messaggio dal sito. Ecco i dettagli:</strong></span></p>
<p style="margin: 0; font-size: 12px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size:16px;"><strong>Nome del contatto: {{$lead->name}}</strong></span></p>
<p style="margin: 0; font-size: 12px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size:16px;"><strong>Email del contatto: {{$lead->email}}</strong></span></p>
<p style="margin: 0; font-size: 12px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size:16px;"><strong>Messaggio: {{$lead->message}}</strong></span></p>
</div>
</div>
</td>
</tr>
...
<div align="center" style="line-height:10px"><img alt="I'm an image" class="big" src="{{asset('img/footer.png' )}}" style="display: block; height: auto; border: 0; width: 640px; max-width: 100%;" title="I'm an image" width="640"/></div>
</td>
</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" class="heading_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
<tr>
<td style="width:100%;text-align:center;">
<h1 style="margin: 0; color: #555555; font-size: 23px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder"><span style="color: #ffffff;">BoolPress</span></span></h1>
</td>
</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" class="text_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
...
<p style="margin: 0; font-size: 14px; text-align: left;"><span style="color:#95979c;font-size:12px;">Boolpress Copyright © 2022</span></p>
</div>
</div>
</td>
</tr>
